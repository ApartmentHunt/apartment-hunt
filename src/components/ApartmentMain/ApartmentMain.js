            ...
            <div className="container mt-3 mb-3">
                ...
                <div className="row text-dark">
                    <div className="col-md-8">
                        ...
                        <br />
                        <h3> <b>Family Apartment Three </b></h3>
                        <p>300 sq-ft, bedroom, Semi-furnished, Luxurious, South-facing Apartment for Rent in </p>
                        ...
                        <p>Address and Area : <br/>
                        Flat Size : 3000 Sq Feet. <br/>
                        Floor :  A5 (5th Floor) (6 storied Building ) (South Facing Unit) <br/>
                        Room Category : Large Bed Rooms with 3 Verandas, Spacious Drawing, Dining and Family Living Room, Highly Decorated Kitchen with Store Room and Servant room with attached Toilet. <br/>
                        ...
                        <div className="adminService p-4">
                            <form action="" onSubmit={handleSubmit(onSubmitEvent)}>
                                <section className="orderServe mt-1">
                                    ...
                                    <div className="mb-3">
                                        <input style={{ border: "none" }} onBlur={handleBlur} className="w-100 mx-auto form-control" value="Palace" name="service" placeholder="Service" ref={register({ required: true })} />
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <input style={{ border: "none" }} onBlur={handleBlur} className="w-100 form-control" value="Price" name="price" placeholder="Price" ref={register({ required: true })} />
                                    ...
                                    <button style={{ fontSize: "12px" }} className="btn btn-warning w-100 p-3" type="submit">Request Booking</button>
